...
<section class="services">
    <div class="container">
        <div class="secTitle">Услуги, которые мы предоставляем</div>
        <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <a href="<?php echo get_page_link( 35 ) ?>" class="service d-flex justify-content-end">
                    <div class="service-img">
                            <img src="<?php echo $theme_path ?>assets/img/services/1.jpg" alt="img" >
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <a href="<?php echo get_page_link( 13 ) ?>" class="service d-flex justify-content-end">
                        <div class="service-img">
                            <img src="<?php echo $theme_path ?>assets/img/services/2.jpg" alt="img" >
                        </div>
                        <div class="service-content">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <a href="<?php echo get_page_link( 15 ) ?>" class="service d-flex justify-content-end">
                    <div class="service-img">
                            <img src="<?php echo $theme_path ?>assets/img/services/3.jpg" alt="img" >
                        </div>
                        <div class="service-content">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <a href="<?php echo get_page_link( 17 ) ?>" class="service d-flex justify-content-end">
                    <div class="service-img">
                            <img src="<?php echo $theme_path ?>assets/img/services/4.jpg" alt="img" >
                        </div>
                        <div class="service-content">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <a href="<?php echo get_page_link( 19 ) ?>" class="service d-flex justify-content-end">
                    <div class="service-img">
                            <img src="<?php echo $theme_path ?>assets/img/services/5.jpg" alt="img" >
                        </div>
                        <div class="service-content">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <a href="<?php echo get_page_link( 21 ) ?>" class="service d-flex justify-content-end">
                    <div class="service-img">
                            <img src="<?php echo $theme_path ?>assets/img/services/6.jpg" alt="img" >
                        </div>
                        <div class="service-content">
