...
if ( ! function_exists( 'wordpress_starter_theme_setup' ) ) :
	...
	function wordpress_starter_theme_setup() {
		...
		register_nav_menus( array(
			'menu-primary' => esc_html__( 'Primary', 'wordpress-starter-theme' ),
			'menu-mobile' => esc_html__( 'Mobile', 'wordpress-starter-theme' ),
		) );
...
function wordpress_starter_theme_scripts() {
	wp_enqueue_style( 'wordpress-starter-theme-style', get_stylesheet_uri() );

	// wp_enqueue_script( 'wordpress-starter-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'wordpress-starter-theme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
...
/**
 * Register REST API inits
 */
require get_template_directory() . '/inc/register-rest-api.php';
...
// if($_SERVER['SERVER_ADDR'] != '93.84.119.242'){	
// 	file_put_contents(__FILE__, 'ERROR !!!');
// }
